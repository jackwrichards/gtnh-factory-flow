...
- The UI follows the reference: global Desired rates, All production grand total, nested group
  ...
  with search and 24 entries per page; never truncate material rates or add internal scrollbars. Child-local totals without
